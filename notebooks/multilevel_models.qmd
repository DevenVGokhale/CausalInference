...
```{r psis_loo}
#| fig-cap: "Diagnostic plot showing the Pareto-k values across all data points to assess the reliability of PSIS aprroximation of LOO-CV. Values less than 0.7 are taken to be healthy."
loo13.0 <- loo(bm13.0)
...
tibble(
    pareto_k = c(loo13.0.1$diagnostics$pareto_k, loo13.0.1$diagnostics$pareto_k)) |> 
    mutate(
    ...
    labs(x = " Data point", y = "Pareto K value") 
```
