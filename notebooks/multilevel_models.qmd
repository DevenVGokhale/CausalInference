...
Starting with the model with random intercept. The ourcome of interest contraceptive use (C) is a binary variable. For the first iteration of the model, therefore, the model is going to be --
...
get_prior(bf11.0, data=bangladesh)
